...
const Planet = () => {
 ...
 <div>
        ...
        <input className="planet4" id="mars" type="radio" name="planet" defaultChecked="checked" />
        ...
        <input className="planet3" id="earth" type="radio" name="planet" defaultChecked="checked" />
        ...
        <input className="planet2" id="venus" type="radio" name="planet" defaultChecked="checked" />
        ...
        <input className="planet1" id="mercury" type="radio" name="planet" defaultChecked="checked" />
